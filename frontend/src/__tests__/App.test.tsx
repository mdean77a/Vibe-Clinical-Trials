...
// Custom render for App component that doesn't double-wrap BrowserRouter
const renderApp = () => {
  return render(<App />, { wrapper: undefined })
}
...
describe('App Integration Tests', () => {
  ...
  it('navigates through complete ICF generation workflow', async () => {
  ...
  it('navigates through complete site checklist workflow', async () => {
    const user = userEvent.setup()
  ...
  it('handles protocol upload workflow', async () => {
    const user = userEvent.setup()
  ...
  it('handles navigation back and forth correctly', async () => {
    const user = userEvent.setup()
  ...
  it('handles direct URL navigation', async () => {
  ...
  it('handles browser back/forward buttons correctly', async () => {
    const user = userEvent.setup()
