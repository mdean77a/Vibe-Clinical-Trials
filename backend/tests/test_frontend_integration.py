...
class TestFrontendBackendIntegration:
    ...
    def test_cors_headers_for_frontend_requests(self):
        ...
        assert "GET, POST, PUT, DELETE, PATCH, OPTIONS" in cors_response["headers"]["access-control-allow-methods"]
        assert "Content-Type, Authorization" in cors_response["headers"]["access-control-allow-headers"]
